  ...
  <div class="q-pa-md">
    <q-layout>
      <q-header elevated class="info">
        <q-toolbar>
          <q-toolbar-title>Compras-Consulta</q-toolbar-title>
        </q-toolbar>
      </q-header>
      <br /><br />
          ...
          <div class="col-sm-12 col-xs-12">
            <q-card class="my-card">
              <q-card-section class="bg-grey-1 text-black">
                <div class="row">
                  ...
                  <div
                    ...
                    style="padding: 0px 10px 10px 10px"
                  >
                    <select class="select-list" v-model="filtro.fornecedores">
                      <option key="default-f">Escolha Fornecedores</option>
                      <option
                        class="select-option"
                ...
                <div class="row">
                  <div
                    ...
                    style="padding: 0px 10px 10px 10px"
                  >
                    <q-input v-model="filtro.valor" label="Valor Compra" />
                  </div>
                  <div
                    class="col-sm-4 col-xs-12"
                    style="padding: 0px 10px 10px 10px"
              ...
              <q-card-actions align="left">
                ...
                <q-btn push color="primary" size="14px" to="/compras-cadastro"
                  >Novo</q-btn
                >
              </q-card-actions>
            </q-card>
            ...
            <table>
              ...
              <tbody>
                <tr :key="item" v-for="item in lista">
                  ...
                  <td>{{ item.fornecedores.razaoSocial }}</td>
                  <td>{{ item.valor }}</td>
...
export default {
  ...
  methods: {
    ...
    handleUpdate (id) {
      this.$router.push(`compras-cadastro/${id}`)
    },
    async handleFiltro () {
      ...
      if (this.filtro.fornecedores && this.filtro.fornecedores !== 'Escolha Fornecedores') {
        this.lista = this.lista.filter((item) =>
          item.fornecedores.razaoSocial.includes(this.filtro.fornecedores.razaoSocial)
        )
      }
