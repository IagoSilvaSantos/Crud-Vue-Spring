...
const routes: RouteConfig[] = [
  {
    ...
    children: [
      ...
      { path: 'vendas-cadastro/:id', component: () => import('pages/vendas/VendasCadastro.vue') },
      ...
      { path: 'compras-cadastro/:id', component: () => import('pages/compras/ComprasCadastro.vue') },
      ...
      { path: 'fornecedores-consulta', component: () => import('pages/fornecedores/FornecedoresConsulta.vue') },
      { path: 'fornecedores-cadastro', component: () => import('pages/fornecedores/FornecedoresCadastro.vue') },
      { path: 'fornecedores-cadastro/:id', component: () => import('pages/fornecedores/FornecedoresCadastro.vue') },
